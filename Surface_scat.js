...
v[5] = v[5].reverse()
t[5] = v[5]
v[6] = ['cy46h_SURFEX_offline_SamuelPR','cy46h_SURFEX_offline_SamuelPR_RSL','cy46h_SURFEX_offline_SamuelPR_RSL_forest','cy46h_sfxoff_SamPR_RSL_lowvegoff']
t[6] = ['cy46h_SURFEX_offline_SamuelPR','cy46h_SURFEX_offline_SamuelPR_RSL','cy46h_SURFEX_offline_SamuelPR_RSL_forest','cy46h_sfxoff_SamPR_RSL_lowvegoff']
v[7] = ['ALL'] ;
t[7] = v[7] ;
